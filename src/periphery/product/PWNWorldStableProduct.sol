...
import { IWorldID } from "pwn/periphery/interfaces/IWorldID.sol";


contract PWNWorldStableProduct is IPWNProduct {
    ...
    string public constant NAME = "PWN World Stable Product";
     ...
     * @param nullifierHash World ID nullifier hash to prevent double-signaling.
     * @param proof World ID zero-knowledge proof.
     */
    ...
    function acceptProposal(
        ...
        // Verify that acceptor is a valid World ID user
        worldId.verifyProof(
			acceptorValues.root,
			groupId,
