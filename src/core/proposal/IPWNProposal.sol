...
/**
 * @title IPWNProposal
 * @notice Interface for PWN proposal contracts that allow accepting loan proposals.
 */
interface IPWNProposal {
     ...
     * @param proposalInclusionProof Merkle proof for proposal inclusion (if required).
     * @param signature Signature for the proposal.
